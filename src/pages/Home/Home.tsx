      ...
      <section className="mt-12 ml-10 mr-10 flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row lg:ml-12 lg:mr-12">
        ...
        <div className="flex flex-col justify-between xl:w-5/12">
          ...
          <div className="sm:text-center lg:py-12 lg:text-left xl:py-24">
            <p className="mb-4 font-semibold text-indigo-500 md:mb-6 md:text-lg lg:text-lg xl:text-xl">
            ...
            <h2 className="mb-8 text-2xl font-bold text-black sm:text-5xl md:mb-12 md:text-4xl lg:text-4xl ">
              Olá {nome}
            </h2>
          ...
          <div className="mt-8 flex items-center justify-center gap-4 sm:mt-16 lg:justify-start">
            ...
            <div className="flex gap-4">
              ...
              <a
                href="https://github.com/eliseflaneuse"
                target="_blank"
                className="text-gray-400 transition duration-100 hover:text-gray-500 active:text-gray-600"
              >
                <svg
